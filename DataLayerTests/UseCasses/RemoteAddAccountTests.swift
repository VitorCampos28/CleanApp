...
class RemoteAddAccountTests: XCTestCase {
    ...
    func test_add_should_complet_with_emial_in_use_error_if_client_completes_with_forbidden() {
        let (sut, httpClientSpy) = makeSut()
    ...
    func test_add_should_not_complete_if_sut_has_been_deallocated() {
        ...
        var sut: RemoteAddAccount? = RemoteAddAccount(url: makeURL(), httpClient: httpClienSpy)
...
extension RemoteAddAccountTests {
    ...
    func makeSut(url: URL = URL(string: "http://any-url.com")!, file: StaticString = #file, line: UInt = #line) -> (sut: RemoteAddAccount, HttpClientSpy) {
    ...
    func expect(_ sut: RemoteAddAccount, completeWith expectedResult: AddAccount.Result, when action: () -> Void,
